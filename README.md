...
<!-- markdownlint-disable MD033 -->
[![master](https://img.shields.io/badge/master-v15.1.0.0-blue.svg)](https://github.com/tasmota/decode-config/tree/master)
...
This will create a file like `Config_Tasmota_15.1.json` (the part `Tasmota` and `15.1` will choosen related to your device configuration).
...
* `Config_Tasmota_15.1.json` using JSON format
...
To restore the previously save backup file `Config_Tasmota_15.1.json` to device `tasmota-4281` use:

```bash
decode-config -c my.conf -s tasmota-4281 --restore-file Config_Tasmota_15.1
```
